...
<div class="topnav">
  ...
  <a href="add.php" class="active">Add Journey/Commute</a>
...
<div class="header">
  	<h2>Add Journey/Commute</h2>
  </div>

<?php
$current_username = $_SESSION['username'];
  	$addquery = "SELECT * FROM users WHERE username='$current_username'";
  	$result = $db->query($addquery);
	$row = $result->fetch_assoc();
	if ($row['drive'] == 'yes') 
{ ?>

  <form method="post" action="add_successful.php">
...
<?php } else { ?>
                 <br>
				 <br>
                <center><h3>You must be a registered driver to add a Journey/Commute</h3></center>
				<?php } ?>
